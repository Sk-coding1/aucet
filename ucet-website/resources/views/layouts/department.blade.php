...
<head>
    ...
    <link href="https://www.auegov.ac.in/Department/public/assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
...
<body>
    ...
    <section id="topbar" class="d-flex align-items-center">
        <div class="container d-flex justify-content-between">
            ...
            <div class="contact-info d-flex">
                <i class="bi bi-envelope mt-1"><a href="mailto:mparams@mitindia.edu">mparams@mitindia.edu</a></i>
                <i class="bi bi-phone mt-1"><a href="tel:4422516179">044 2251 6179</a></i>
                <div class="social-links mt-1">
                    <a href="https://twitter.com/auvcochennai" target="_blank" class="twitter "><i class="bi bi-twitter-x"></i></a>
                    <a href="https://www.facebook.com/auchennaiofficial" target="_blank" class="facebook ms-3"><i class="bi bi-facebook"></i></a>
                    <a href="https://www.instagram.com/anna_university.chennai/" target="_blank" class="instagram ms-3"><i class="bi bi-instagram"></i></a>
                    <a href="https://www.youtube.com/channel/UCvR0vYmjwNCmVFyTdSAKvMA" target="_blank" class="youtube ms-3"><i class="bi bi-youtube"></i></a>
                </div>
            </div>
        </div>
    </section>
                 ...
                 <!--    <li class='dropdown'><a class='research' href='#'><span>Research</span><i class='bi bi-chevron-down'></i></a>
                        <ul>
                            <li class='dropdown'><a class='awarded' href='#'><span>Awarded</span><i class='bi bi-chevron-right'></i></a>
                                <ul>
                                    <li><a class='phdawarded' href='https://www.auegov.ac.in/Department/aerospace/phdawarded'>Ph.D</a></li>
                                </ul>
                            </li>
                            <li class='dropdown'><a class='publication' href='#'><span>Publication</span><i class='bi bi-chevron-right'></i></a>
                                <ul>
                                    <li><a class='journals' href='https://www.auegov.ac.in/Department/aerospace/journals'>Journals</a></li>
                                    <li><a class='conferences' href='https://www.auegov.ac.in/Department/aerospace/conferences'>Conferences</a></li>
                                </ul>
                            </li>
                            <li><a class='projects' href='https://www.auegov.ac.in/Department/aerospace/projects'>Projects</a></li>
        ...
        <div class="footer-top">
            <div class="container ">
                <div class="d-flex justify-content-between">
                    <h3 data-aos="flip-down">Department of <span> Information Technology</span></h3>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 footer-contact" data-aos="fade-right">
                        ...
                        <div class="social-links">
                            <a href="https://twitter.com/auvcochennai" target="_blank" class="twitter "><i class="bi bi-twitter-x"></i></a>
                            <a href="https://www.facebook.com/auchennaiofficial" target="_blank" class="facebook"><i class="bi bi-facebook"></i></a>
                            <a href="https://www.instagram.com/anna_university.chennai/" target="_blank" class="instagram"><i class="bi bi-instagram"></i></a>
                            <a href="https://www.youtube.com/channel/UCvR0vYmjwNCmVFyTdSAKvMA" target="_blank" class="youtube"><i class="bi bi-youtube"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6 footer-links" data-aos="fade-down">
                        <h4>Useful Links</h4>
                        <ul>
                            <li><i class="bi bi-caret-right"></i> <a href="https://www.annauniv.edu/" target="_blank">Anna University</a></li>
                            <li><i class="bi bi-caret-right"></i> <a href="https://mitindia.edu/en/" target="_blank">MIT Campus</a></li>
                            <li><i class="bi bi-caret-right"></i> <a href="https://www.auegov.ac.in/" target="_blank">Centre for e-Governance</a></li>
                            <li><i class="bi bi-caret-right"></i> <a href="https://aucoe.annauniv.edu/" target="_blank">Controller of Examination</a></li>
                            <li><i class="bi bi-caret-right"></i> <a href="https://acoe.annauniv.edu/" target="_blank">Additional Controller of Examination</a></li>
                            <li><i class="bi bi-caret-right"></i> <a href="https://cac.annauniv.edu/" target="_blank">Centre for Academic Courses</a></li>
                            <li><i class="bi bi-caret-right"></i> <a href="https://www.annauniv.edu/dsa/" target="_blank">Centre for Student Affairs</a></li>
                        </ul>
                    </div>
        ...
        <div class="container py-4">
            <div class="copyright">
                <span class="footer-icon">
                    <a href="https://www.auegov.ac.in/index.html" target="_blank"><img class="footer-icon-img" src="https://www.auegov.ac.in/Department/public/assets/img/CeGov.png" alt="" /></a>
                </span>
                &copy; Copyright 2024 ,<strong><span><a href="https://www.auegov.ac.in/index.html" target="_blank"> CeGov </a></span></strong> ,Anna University - All rights reserved.
            </div>
            <div class="credits">
    ...
    <!-- Vendor JS Files -->
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/purecounter/purecounter_vanilla.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/aos/aos.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/bootstrap/js/bootstrap.bundle.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/popper/popper.min.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/glightbox/js/glightbox.min.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/isotope-layout/isotope.pkgd.min.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/swiper/swiper-bundle.min.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/waypoints/noframework.waypoints.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/php-email-form/validate.js"></script>
    <script src="https://www.auegov.ac.in/Department/public/assets/vendor/wow/wow.min.js"></script>
    <!-- Main jquery File -->
    <script language="JavaScript" type="text/javascript" src="https://www.auegov.ac.in/Department/public/assets/vendor/jquery/jquery.min.js"></script>
    <!--Main JS File -->
    <script src="https://www.auegov.ac.in/Department/public/assets/js/main.js"></script>
    <script>
